...
cp /output/sgc/packages.list config/package-lists/custom.list.chroot
...
cp /output/sgc/hooks/normal/020-apps.hook.chroot config/hooks/normal/020-apps.hook.chroot
cp /output/sgc/hooks/normal/020-themes.hook.chroot config/hooks/normal/020-themes.hook.chroot
cp /output/sgc/hooks/normal/999-desktop-config.hook.chroot config/hooks/normal/999-desktop-config.hook.chroot
...
cp -r /output/sgc/includes.chroot/etc config/includes.chroot/
cp -r /output/sgc/includes.chroot/usr config/includes.chroot/
